...
{
	private static final StructurePieceType PIECE_TYPE = UhcRegistry.registerStructurePieceType(me.fallenbreath.tcuhc.gen.structure.PlainCottageStructure.Piece::new, "plain_cottage_piece");
	...
	private static void addPieces(StructurePiecesCollector collector, StructurePiecesGenerator.Context<DefaultFeatureConfig> context)
	{
		...
		collector.addPiece(new me.fallenbreath.tcuhc.gen.structure.PlainCottageStructure.Piece(context, MAIN_TEMPLATE, shiftStartPosRandomly(context), rotation));
	}
