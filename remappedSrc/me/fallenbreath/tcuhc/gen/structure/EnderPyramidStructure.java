...
{
	private static final StructurePieceType PIECE_TYPE = UhcRegistry.registerStructurePieceType(me.fallenbreath.tcuhc.gen.structure.EnderPyramidStructure.Piece::new, "ender_pyramid_piece");
	...
	private static void addPieces(StructurePiecesCollector collector, StructurePiecesGenerator.Context<DefaultFeatureConfig> context)
	{
		...
		collector.addPiece(new me.fallenbreath.tcuhc.gen.structure.EnderPyramidStructure.Piece(context.structureManager(), MAIN_TEMPLATE, shiftStartPosRandomly(context), rotation));
	}
