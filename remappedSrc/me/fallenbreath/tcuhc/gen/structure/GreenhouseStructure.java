...
public class GreenhouseStructure extends SinglePieceLandStructure<GreenhouseConfig>
{
	...
	private static final StructurePieceType SNOW_PIECE_TYPE = UhcRegistry.registerStructurePieceType(me.fallenbreath.tcuhc.gen.structure.GreenhouseStructure.Piece::new, "greenhouse_piece_" + SNOW);
	private static final StructurePieceType DESERT_PIECE_TYPE = UhcRegistry.registerStructurePieceType(me.fallenbreath.tcuhc.gen.structure.GreenhouseStructure.Piece::new, "greenhouse_piece_" + DESERT);
	...
	{
		collector.addPiece(new me.fallenbreath.tcuhc.gen.structure.GreenhouseStructure.Piece(context, shiftStartPosRandomly(context), context.config()));
	}
	...
	private static void postGenerated(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, StructurePiecesList children)
	{
		...
		if (!pieces.isEmpty())
		{
			...
			if (piece instanceof me.fallenbreath.tcuhc.gen.structure.GreenhouseStructure.Piece)
			{
				String type = ((me.fallenbreath.tcuhc.gen.structure.GreenhouseStructure.Piece) piece).getGreenhouseType();
